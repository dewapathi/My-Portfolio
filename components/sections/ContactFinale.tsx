  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse, rgba(108,140,255,0.18) 0%, transparent 70%)",
        }}
      />
        ...
        <div className="section-inner">
          ...
          >
            <button
              ...
              data-cursor="Copy"
              className="relative inline-flex items-center gap-2.5 rounded-xl bg-[var(--accent)] px-6 py-3.5 text-sm font-semibold text-white shadow-[0_8px_32px_rgba(108,140,255,0.35)] hover:bg-[var(--accent-hover)] transition-colors"
            >

...
export default function Skills() {
  ...
  return (
    <section
      id="skills"
      ref={ref}
      className="section-padding scroll-mt-24 bg-gradient-to-b from-white via-gray-50/50 to-white dark:from-gray-950 dark:via-gray-900/50 dark:to-gray-950 relative overflow-hidden"
    >
      {/* Background Pattern */}
